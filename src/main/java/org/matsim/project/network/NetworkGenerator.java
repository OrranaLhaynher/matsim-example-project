...
class NetworkGenerator {
	...
	public static void main(String [] args) throws SAXException {
		...
		new NetworkWriter(net).write("C:\\Users\\orran\\OneDrive\\Documentos\\GitHub\\matsim-example-project\\original-input-data\\evacuationArea.xml");//here we write the network to a xml file
